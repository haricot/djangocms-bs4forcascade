...
class BootstrapAccordionCardPlugin(TransparentContainer, BootstrapPluginBase):
    ...
    glossary_field_order = ['card_title', 'heading_size', 'card_type']
