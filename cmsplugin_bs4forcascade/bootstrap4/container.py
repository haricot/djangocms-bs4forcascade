...
class ContainerBreakpointsWidget(widgets.CheckboxSelectMultiple):
    template_name = 'cascade/forms/widgets/container_breakpoints_bs4.html'
            ...
            format_html_join('',
                '<div class="field-box">'
                    '<div class="container-thumbnail">'
                        '<img src="' + settings.STATIC_URL + 'cascade-bs4/admin/breakpoints/{1}.svg" style="height: 55px;" />'
...
class Bootstrap4ContainerPlugin(BootstrapPluginBase):
    ...
    def get_css_classes(cls, obj):
        css_classes = cls.super(Bootstrap4ContainerPlugin, cls).get_css_classes(obj)
...
class Bootstrap4RowPlugin(BootstrapPluginBase):
    name = _("Row")
    default_css_class = 'row'
    parent_classes = ('Bootstrap4ContainerPlugin', 'Bootstrap4ColumnPlugin', 'BootstrapJumbotronPlugin')
...
class Bootstrap4ColumnPlugin(BootstrapPluginBase):
    name = _("Column")
