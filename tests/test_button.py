...
from cms_bootstrap4.bootstrap.buttons import Bootstrap4ButtonPlugin
...
class ButtonWrapperPluginTest(CascadeTestCase):
    def test_plugin_context(self):
        ...
        model_instance = add_plugin(self.placeholder, Bootstrap4ButtonPlugin, 'en', glossary=glossary)
        button_plugin = model_instance.get_plugin_class_instance()
        self.assertIsInstance(button_plugin, Bootstrap4ButtonPlugin)
