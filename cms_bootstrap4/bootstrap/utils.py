...
BS4_BREAKPOINTS = OrderedDict(settings.CMSPLUGIN_CASCADE['bootstrap4']['breakpoints'])
...
def reduce_breakpoints(plugin, field_name, request=None, obj=None):
    ...
    in case the container was defined with a subset of these breakpoints: xs, sm, md, lg,xl.
    """
