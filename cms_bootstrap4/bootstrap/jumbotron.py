...
from .utils import get_widget_choices, compute_media_queries, get_picture_elements, BS4_BREAKPOINT_KEYS
...
class BootstrapJumbotronPlugin(Bootstrap4PluginBase):
    name = _("Jumbotron")
    ...
    container_glossary_fields = (
        GlossaryField(
            ...
            name='breakpoints',
            initial=list(BS4_BREAKPOINT_KEYS)[::-1],
